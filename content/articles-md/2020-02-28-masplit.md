...
*MASPLIT* (means *magnet* and *split*) is a homemade, 3D printed, ergonomic, ortholinear, split, programmable keyboard.
After I made the [3D printed *NOVEM* keypad](/novem) I decided to build a larger keyboard.

I had the idea of making a split keyboard. Since the two parts of the keyboard are not separated, you can place them as
...
- 2 3-poles 3.5 mm TRRS female connectors;
- 2 3-poles 3.5 mm TRRS male connectors;
- 1 paracord sleeve**;
- 10 1*5 mm circular magnets;
- 24 M2 screws;
- 24 M2 nuts.

> \* Connector holders and 3D printed parts which hold in place the keyboard connectors such as 2 micro USB female and 2 3-poles 3.5 mm TRRS female connectors.

> \*\* The paracord sleeve is needed to make the sleeve of the handmade 3-poles TRRS cable.
...
- **has to be entirely 3D printed, without glue** (I so can change or update parts easily).
...
It has the same design as the [PUCH keyboard](/puch) that I made, except that it is split in half 😉.
...
*MASPLIT* needs to be connected to the computer by micro USB and connect the two separated parts by a 3-poles TRRS (jack
...
keyboard, the 3-poles TRRS connector is on the left, and the micro USB connector is on the right.
...
Building it was the longest part of the whole project. I'm going to break down the 3D printing and wiring processes.
...
each part. All the columns and rows are connected to it, as well as the 3-poles TRRS females connectors. These two
connectors will allow the two MCUs to *talk* to each other.

![Wiring of the MCUs and 3-poles TRRS female connectors][wiring-mcus]
<p style="text-align: center; font-style: italic;">
    Wiring of the MCUs and 3-poles TRRS female connectors.
</p>
...
I then attached the 3D printed 3-poles TRRS and micro USB connector holder to the two connectors, and made holes in the
...
<p style="text-align: center; font-style: italic;">
    Connectors soldered and with their 3D printed connector holders on the left part of the keyboard. 3-poles TRRS (left) and micro USB (right).
</p>

I also built my own TRRS male-to-male cable (jack cable) because why not 😉. I got two 3-poles TRRS male connectors,
